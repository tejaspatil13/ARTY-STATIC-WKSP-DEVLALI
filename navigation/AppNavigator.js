  ...
  return (
    <Stack.Navigator initialRouteName="Main">
      ...
      <Stack.Screen
        ...
        options={{ title: "Liquor Issue" }}
      />
      <Stack.Screen
        name="RollCall"
        component={RollCallPage}
        options={{ title: "Roll Call" }}
      />
      <Stack.Screen
        name="SaleCSD"
        component={SaleCSDPage}
        options={{ title: "Sale CSD" }}
      />
      <Stack.Screen
        name="QtrVisit"
        component={QtrVisitPage}
        options={{ title: "Quarter Visit" }}
      />
      <Stack.Screen
        name="MobileCheck"
        component={MobileCheckPage}
        options={{ title: "Mobile Check" }}
      />
      <Stack.Screen
